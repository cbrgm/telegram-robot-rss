...
class rssbot(object):
    ...
    def __init__(self, telegram_token, update_interval):
        ...
        self.db = util.DatabaseHandler("resources/datastore.db")
        self.fh = util.FileHandler("..")
    ...
    def start(self, bot, update):
        ...
        if self.db.get_user(telegram_id=telegram_user.id) is None:
        ...
        self.db.update_user(telegram_id=telegram_user.id, is_active=True)
        update.message.reply_text(_("start_message01"))
...
if __name__ == '__main__':
    ...
    rssbot(telegram_token=token, update_interval=update)
